...
Expecty 0.4 was released on August 4th, 2012. It requires Scala 2.10.0-M6 or higher. For Scala 2.10.0-M5 you can still use Expecty 0.3.
...
val expecty = "org.expecty" % "expecty" % "0.4"
```
...
dependencies {
  testCompile "org.expecty:expecty:0.4"
}
```
